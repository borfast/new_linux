...
## Development shit
sudo apt-get -y install sublime-text build-essential python-setuptools python-dev apache2 nodejs php5 php5-cli php5-json php5-mysql php5-pgsql php5-sqlite php5-dev php5-curl php5-gd php5-mcrypt git git-flow gitg openjdk-7-jdk terminator meld mysql-client mysql-server postgresql postgresql-client ruby ruby-dev ruby2.0 ruby2.0-dev mysql-workbench libsqlite3-dev libmysqlclient-dev libpq-dev
